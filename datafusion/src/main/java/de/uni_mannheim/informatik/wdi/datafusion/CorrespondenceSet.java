...
//				grp2.addRecord(values[0], first);
//				int i=0;
//				Map<String, FusableDataSet<RecordType>> m = grp2.records;
//				for( Entry<String, FusableDataSet<RecordType>> entry : m.entrySet()){
//					RecordGroup<RecordType> grp3 = new RecordGroup<RecordType>();
//					grp3.addRecord(entry.getKey(), entry.getValue());
//					recordIndex.put(values[0], grp3);
//			
//				}
